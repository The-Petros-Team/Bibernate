...
public enum ExceptionMessages {
    ...
    public static final String NULL_ENTITY_PERSISTENCE_CONTEXT_SNAPSHOT_EXCEPTION = "Entity that you want to do snapshot must not be null!";
    public static final String NULL_ENTITY_PERSISTENCE_CONTEXT_CACHE_EXCEPTION = "Entity that you want to put in cache must not be null!";
